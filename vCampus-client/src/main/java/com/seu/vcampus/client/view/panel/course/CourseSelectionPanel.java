...
public class CourseSelectionPanel extends JPanel implements CoursePanel.Refreshable{
    ...
    private void initUI() {
        ...
        // 状态标签
        JLabel statusLabel = new JLabel("学生: " + currentUser.getName() + "(" + currentUser.getCid() + ")");
    ...
    private void loadSelectedCourses() {
        // 从数据库获取已选课程
        List<Course> selectedCourses = courseController.getCoursesByStudentId(currentUser.getCid(), currentUser);
        ...
        public Object getCellEditorValue() {
            if (isPushed) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    // 执行退课操作
                    boolean success = courseController.dropCourse(currentUser.getCid(), courseId,currentUser);
